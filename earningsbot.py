...
Original file is located at
    https://colab.research.google.com/drive/1EYF-fRHTDYmQALYGB5sGJ4II2t_3Emnv
"""
...
def init(symbols, state: blankly.StrategyState):
    ...
    for symbol in symbols:
      if not exists('CalendarJSONs/'+symbol + '.json'):
        result = requests.get('https://financialmodelingprep.com/api/v3/historical/earning_calendar/'+symbol+'?apikey=09a505eb7acf60470a29cc9adbcaa0c1')
        data = result.json()
